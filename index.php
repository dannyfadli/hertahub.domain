...
<body>
    ...
    <div id="main">
        ...
        <div>
            ...
            <ol>
                <li>
                    <b>Ridwan Fahmidina Pamungkas (20230140185)</b>
                    "- Pengembang fitur Forum"
                <li>
                <br>
                <li>
                    <b>Naufal Muhammad Daffa (20230140166) </b>
                    "-Manajemen Database & OAuth API"
                <li>
                <br>
                <li>
                    <b>Ardhian Fadli Rabbani (20230140156) </b>
                    "- Pemgembangan Kelola User Untuk Role Admin"
                <li>
                <br>
                <li>
                    <b>Galang Yudha Priambodo (20230140176) </b>
                    "- Penyusun Halaman Profil"
                <li>
                <br>
                <li>
                    <b>Avanro Naufal Teknologi Informasi (20230140199) </b>
                    "- Pengembang Menu Login/Register"
                <li>
                <br>
                <li>
                    <b>Arthur Gerald Arya Wirayudha (20230140196) </b>
                    "- Pengelola halaman Home"
                <li>
                <br>
                <li>
                    <b>Afnan Asilah Prayogi (20230140153) </b>
                    "- Pengembang Login/Register"
                <li>
                <br>
                <li>
                    <b>Rangga Ramadhana (20230140155) </b>
                    "-Tester/Qa"
                <li>
            <ol>
            <p></p>
